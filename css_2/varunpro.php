...
<body>
 <header id="home">
      ...
      <nav id="nav-wrap">
       ...
       <li id="top_bar"><button class="btn btn-link" onclick="location.href='deleteSurvey.php';">Retake Survey</button></li>
 ...
 <img id="profile_pic" src="img_meet/the_great_shah.jpg" alt="btp">
